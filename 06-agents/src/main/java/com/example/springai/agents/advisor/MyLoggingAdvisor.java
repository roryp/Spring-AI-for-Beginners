...
/**
 * A logging advisor that intercepts ChatClient requests and responses,
 * printing useful debugging information about user prompts, system messages,
 * tool calls, and assistant responses.
 *
 * <p>Adapted from the VoxxedDays 2026 Spring AI demo by Christian Tzolov.</p>
 *
 * @see <a href="https://github.com/tzolov/voxxeddays2026-demo">VoxxedDays 2026 Demo</a>
 */
public class MyLoggingAdvisor implements BaseAdvisor {
    ...
    private MyLoggingAdvisor(int order, boolean showSystemMessage, boolean showAvailableTools,
            boolean showConversationHistory, String labelPrefix, AdvisorLogSink logSink) {
        this.order = order;
    ...
    public ChatClientRequest before(ChatClientRequest chatClientRequest, AdvisorChain advisorChain) {
        ...
        System.out.println(ORANGE + logMessage + RESET);
        if (logSink != null) {
            logSink.emit("REQUEST", logMessage);
        }
    ...
    public ChatClientResponse after(ChatClientResponse chatClientResponse, AdvisorChain advisorChain) {
        ...
        System.out.println(ORANGE + logMessage + RESET);
        if (logSink != null) {
            logSink.emit("RESPONSE", logMessage);
        }
    ...
    public static class Builder {
        ...
        private AdvisorLogSink logSink;
        ...
        public Builder logSink(AdvisorLogSink logSink) {
            this.logSink = logSink;
            return this;
        }
        ...
        public MyLoggingAdvisor build() {
            return new MyLoggingAdvisor(this.order, this.showSystemMessage,
                    this.showAvailableTools, this.showConversationHistory, this.labelPrefix, this.logSink);
        }
    }
}
